...
class Event(var id: Int, // Independent id, identifying the event in the system (not in the Genetic Algorithm)
            ...
            var happensAfterTask: Int, // The id of event, which has to happen before this event, if this requirement do not apply, the value is -1
            ...
            var happensAfterTime: Int, // The timeslot, after which this event has to happen, if this requirement do not apply, the value is -1
            ...
            var canSeparate: Boolean = false) // Defines if the task can be split into multiple instances in the schedule